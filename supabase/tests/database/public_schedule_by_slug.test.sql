...
values('59000000-0000-0000-0000-000000000021','59000000-0000-0000-0000-000000000001','Profissional Schedule','92999990005',0,true,'{"monday":{"active":true,"start":"09:00","end":"12:00"}}');
...
select is((select count(*)::integer from public.get_public_schedule_by_slug('schedule-test','2040-01-02','59000000-0000-0000-0000-000000000011',null) where available),5,'qualified professional makes only slots that fit before closing available');
