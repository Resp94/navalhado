...
select has_function('public', 'settle_comanda', array['uuid','uuid','uuid','uuid','numeric','numeric','uuid','jsonb','jsonb','uuid','numeric'], 'finalizacao atomica presente');
...
select has_function('public', 'register_commission_payout', array['uuid','numeric','text','text','timestamp with time zone','uuid','uuid','numeric','numeric'], 'quitacao protegida presente');
