...
values('58000000-0000-0000-0000-000000000001','Catalog Test','catalog-test@test.local','92999990002','catalog-test',true);

insert into public.services(id,tenant_id,name,description,price,duration_minutes,category,is_active,display_order)
values
  ('58000000-0000-0000-0000-000000000011','58000000-0000-0000-0000-000000000001','Corte Publico',null,40,40,'Cabelo',true,1),
  ('58000000-0000-0000-0000-000000000012','58000000-0000-0000-0000-000000000001','Servico Inativo',null,40,40,'Cabelo',false,2);

insert into public.professionals(id,tenant_id,name,phone,commission_percentage,is_active,weekly_schedule)
values('58000000-0000-0000-0000-000000000021','58000000-0000-0000-0000-000000000001','Profissional Publico','92999990003',0,true,'{}');
...
select is((select name from public.get_services_by_public_slug('catalog-test')),'Corte Publico'::text,'public service is tenant scoped');
