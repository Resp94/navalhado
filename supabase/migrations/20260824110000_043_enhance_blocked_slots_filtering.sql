-- Migration: 043_enhance_blocked_slots_filtering
-- Description: Garante que bloqueios de horário (individuais ou globais/tenant) sejam rigorosamente excluídos da listagem pública e validados na criação do agendamento
-- Date: 2026-08-24
...
-- 2. Atualizar create_appointment_by_token para verificar bloqueios de forma abrangente
