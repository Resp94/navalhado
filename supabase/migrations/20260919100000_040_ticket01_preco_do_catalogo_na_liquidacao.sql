-- Spec 040, ticket 01: o preco de cada Item de Comanda vem do catalogo.
--
-- Produto e servico de preco fixo (price_type = 'fixed') sao gravados pelo
-- preco cadastrado, ignorando o unit_price enviado pela tela. Servico
-- 'starting_at' aceita o valor informado, desde que nao fique abaixo do preco
-- cadastrado. Todo abatimento passa a ser feito so pelo desconto da Comanda.
--
-- Unica mudanca sobre a versao vigente (20260913150000): a resolucao de preco
-- logo apos a validacao dos itens. settle_comanda_idempotent so repassa
-- os parametros e nao muda.
