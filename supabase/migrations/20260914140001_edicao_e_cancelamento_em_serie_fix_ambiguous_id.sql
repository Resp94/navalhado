-- Fix da migration 20260914140000: `id` e um parametro OUT de
-- update_payable_series/cancel_payable_series (por causa do `returns table`),
-- entao qualquer referencia nao qualificada a uma coluna `id` (ou a outras
-- colunas em tabelas consultadas dentro do corpo dessas funcoes) fica
-- ambigua. Mesma classe de bug ja vista no ticket 07/036
-- (list_payable_settlements) -- corrigida aqui qualificando toda tabela
-- consultada com alias.
