-- Spec 024: usuarios anonimos sao a identidade temporaria da sessao publica.
-- Eles nao devem ser projetados para public.users, que exige email e representa
-- usuarios administrativos/profissionais da aplicacao.
