-- Migration 090: reconcilia o RPC de primeiro contato do WhatsApp.
--
-- Garante que novos clientes tenham telefone_normalizado persistido e que o
-- RETURNING continue usando o alias da tabela para evitar ambiguidade com o
-- nome da coluna retornada pela função.
