# 08: Pagamento de gorjeta na Quitação de Comissão
...
Como no ticket 07, o estorno pertence a este ticket: separá-los criaria uma janela em que estornar
uma quitação deixaria a gorjeta marcada como paga sem ter sido.

Este ticket **libera** o parâmetro de créditos que o ticket 07 já acrescentou à assinatura e
mantinha recusado — nenhuma alteração de assinatura nova, nenhum privilégio refeito.

**Blocked by:** 07 (abate de vale na quitação).
...
- [ ] Créditos pagos ficam vinculados à quitação pela mesma tabela de rateio do ticket 07.
- [ ] A ordem de lock estabelecida no ticket 07 é preservada.
