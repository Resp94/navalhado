...
- [x] Bloco `<style>` inline de cada página listada removido e convertido
- [x] Criar, editar, arquivar/desarquivar e excluir em cada uma dessas telas verificados manualmente sem mudança de comportamento
