...
- [x] Caracterizar os contratos públicos usados pelos repositórios de Produtos, Comandas, Caixa e Financeiro.
- [x] Cobrir os fluxos atuais bem-sucedidos de abertura e fechamento de caixa, fechamento e reabertura de comanda e quitação de comissão.
- [x] Registrar em testes a incompatibilidade atual entre os tipos de movimento aceitos pelo schema e pela função de estoque.
- [x] Registrar em testes os limites atuais de autorização, isolamento por tenant e usuário ativo.
- [x] Executar as suítes existentes do escopo e guardar o resultado como baseline.
