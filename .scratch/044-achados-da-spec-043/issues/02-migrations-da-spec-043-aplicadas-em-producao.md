# 02: Migrations da spec 043 aplicadas em produção
...
**Blocked by:** 01 (Provas de banco da spec 043) — produção só recebe migration cujos testes foram executados no estado atual

**Status:** ready-for-agent

- [ ] A observação da entrada da Lista de Espera existe em produção (migration do ticket 01 da spec 043)
- [ ] A autoria do cancelamento existe em produção, com o domínio fechado, e as quatro funções de cancelamento gravam a autoria (migration do ticket 06 da spec 043)
- [ ] A marca de Agendamento vindo da Lista de Espera existe em produção e a função de criação pelo gestor a grava (migration do ticket 07 da spec 043)
