...
- [ ] A nota sobre as funções de cancelamento nomeia a quarta via e diz que ela grava autoria mas não motivo, apontando para o ticket 07 da spec 044, que resolve isso
- [ ] A nota sobre Bloqueios aponta para o ticket 08 da spec 043 e descreve o contrato dividido
- [ ] A nota sobre a Lista de Espera descreve a coluna própria e aponta para o ticket 17 da spec 044, que leva a medida ao relatório
- [ ] A nota sobre a escrita da autoria aponta para o ticket 08 da spec 044, que a protege no banco
