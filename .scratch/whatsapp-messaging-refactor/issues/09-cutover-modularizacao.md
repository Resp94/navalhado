...
- [ ] A fachada atual continua atendendo triggers, cron jobs e callers durante a transição.
- [ ] Cada capacidade migrada possui um único caminho de entrega, sem dual-send.
- [ ] O cutover pode ser revertido pela versão da Edge Function sem apagar ledger, outbox ou histórico.
