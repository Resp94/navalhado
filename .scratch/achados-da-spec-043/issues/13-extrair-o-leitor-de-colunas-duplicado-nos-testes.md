...
**What to build:** vários testes de adaptador usam um banco de mentira que aplica de verdade os filtros e devolve só as colunas pedidas na consulta. Sem isso, um teste passaria mesmo se o adaptador esquecesse de pedir uma coluna, que foi exatamente o defeito original de dois tickets da spec 043.
