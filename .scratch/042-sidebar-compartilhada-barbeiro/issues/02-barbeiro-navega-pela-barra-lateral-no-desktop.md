...
- [x] O barbeiro vê nome e logo da barbearia na barra lateral e volta para a Minha Agenda clicando neles
- [x] Notificações e Sair funcionam pela barra lateral, com o mesmo comportamento que tinham no cabeçalho
- [x] A área de conteúdo fica irmã da barra lateral, no mesmo arranjo do layout do gestor, sem a largura máxima centralizada que existia por causa do cabeçalho
