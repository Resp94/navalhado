...
const faturamentoFixture = {
  ...
  totals: { gross: 100, discounts: 0, net: 100, services_net: 100, products_net: 0, tips: 0, closed_comandas: 1 },
  previous_totals: { gross: 0, discounts: 0, net: 0, services_net: 0, products_net: 0, tips: 0, closed_comandas: 0 },
  buckets: [],
};
